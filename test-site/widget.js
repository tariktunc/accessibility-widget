...
:host {\r
  all: initial;\r
  font-family: 'Poppins', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;\r
  font-size: 15px;\r
  font-weight: 500;\r
  line-height: 1.55;\r
  color: var(--__text);\r
...
.fab {\r
  position: fixed;\r
  inset-block-end: 1rem;\r
  inset-inline-start: 1rem;\r
  width: var(--blakfy-a11y-fab-size);\r
  height: var(--blakfy-a11y-fab-size);\r
  min-width: 44px;\r
  min-height: 44px;\r
  ...
  background: var(--blakfy-a11y-primary);\r
  color: var(--blakfy-a11y-primary-text);\r
  box-shadow: 0 8px 24px rgba(59,130,246,0.35);\r
  transition: background 200ms ease, transform 200ms ease;\r
  z-index: 9998;\r
}\r
\r
.fab:hover {\r
  background: var(--blakfy-a11y-primary-hover);\r
  transform: scale(1.06);\r
}\r
\r
.fab:focus-visible {\r
  outline: 2px solid var(--blakfy-a11y-focus-ring);\r
  outline-offset: 3px;\r
}\r
\r
:host([data-position="bottom-right"]) .fab {\r
  inset-inline-start: auto;\r
  inset-inline-end: 1rem;\r
}\r
:host([data-position="top-left"]) .fab {\r
  inset-block-end: auto;\r
  inset-block-start: 1rem;\r
}\r
:host([data-position="top-right"]) .fab {\r
  inset-block-end: auto;\r
  inset-block-start: 1rem;\r
  inset-inline-start: auto;\r
  inset-inline-end: 1rem;\r
...
\r
.fab svg { width: 24px; height: 24px; }\r
\r
\r
/* ==========================================================================\r
 * 7. Dialog — sağdan kayan sidebar\r
 * ========================================================================== */\r
.backdrop {\r
  position: fixed;\r
  inset: 0;\r
  ...
  z-index: 9999;\r
  animation: blakfy-fade-in 200ms ease forwards;\r
}\r
.backdrop[data-state="closing"] { animation: blakfy-fade-out 180ms ease forwards; }\r
\r
.dialog {\r
  position: fixed;\r
  inset-block-start: 0;\r
  inset-inline-end: 0;\r
  inline-size: 400px;\r
  max-inline-size: 100vw;\r
  block-size: 100vh;\r
  overflow-y: auto;\r
  background: var(--__bg);\r
  color: var(--__text);\r
  z-index: 10000;\r
  box-shadow: -12px 0 40px rgba(0,0,0,0.22);\r
  scrollbar-width: thin;\r
  scrollbar-color: var(--__divide) transparent;\r
  animation: blakfy-slide-in-right 240ms cubic-bezier(0.25,0.46,0.45,0.94) forwards;\r
}\r
.dialog[data-state="closing"] { animation: blakfy-slide-out-right 190ms ease forwards; }\r
.dialog:focus { outline: none; }\r
\r
/* ==========================================================================\r
 * 8. Panel header\r
 * ========================================================================== */\r
.panel-header {\r
  ...
  padding: 1.25rem 1.5rem 1rem;\r
  background: var(--__header-bg);\r
  border-block-end: 1px solid var(--__divide);\r
}\r
\r
.panel-title {\r
  font-size: 17px;\r
...
.dialog-close {\r
  ...
  border-radius: 3px;\r
  color: var(--__muted);\r
  transition: background 150ms ease, color 150ms ease;\r
  flex-shrink: 0;\r
}\r
.dialog-close:hover { background: var(--__divide); color: var(--__text); }\r
.dialog-close:focus-visible { outline: 2px solid var(--blakfy-a11y-focus-ring); outline-offset: 2px; }\r
.dialog-close svg { width: 18px; height: 18px; }\r
\r
/* ==========================================================================\r
 * 9. Section labels\r
 * ========================================================================== */\r
.section-label {\r
  ...
  color: var(--__text);\r
  padding: 1.125rem 1.5rem 0.5rem;\r
  opacity: 0.9;\r
}\r
\r
.opt-section-title {\r
...
.switch {\r
  ...
  block-size: 26px;\r
  border-radius: 9999px;\r
  background: var(--__switch-off);\r
  transition: background 200ms ease;\r
}\r
.switch[aria-checked="true"] { background: var(--blakfy-a11y-primary); }\r
.switch:focus-visible { outline: 2px solid var(--blakfy-a11y-focus-ring); outline-offset: 2px; }\r
.switch::before { content: ""; position: absolute; inset: -8px; }\r
\r
.switch-thumb {\r
  position: absolute;\r
  inset-block-start: 3px;\r
  inset-inline-start: 3px;\r
  inline-size: 20px;\r
  block-size: 20px;\r
  border-radius: 9999px;\r
  background: #ffffff;\r
...
.switch[aria-checked="true"] .switch-thumb { transform: translateX(18px); }\r
[dir="rtl"] .switch[aria-checked="true"] .switch-thumb { transform: translateX(-18px); }\r
\r
/* ==========================================================================\r
 * 11. Profile list\r
 * ========================================================================== */\r
...
.profile-list-item {\r
  ...
  background: var(--__card);\r
  border-radius: 3px;\r
  cursor: pointer;\r
  border: none;\r
  outline: 2px solid transparent;\r
  transition: background 150ms ease, outline-color 150ms ease;\r
  text-align: start;\r
  width: 100%;\r
}\r
.profile-list-item:hover { background: var(--__card-hover); }\r
.profile-list-item--active {\r
  background: var(--__card-active);\r
  outline-color: var(--blakfy-a11y-primary);\r
}\r
.profile-list-item:focus-visible { outline-color: var(--blakfy-a11y-focus-ring); }\r
\r
.profile-list-icon { color: var(--blakfy-a11y-primary); flex-shrink: 0; }\r
.profile-list-icon svg { width: 18px; height: 18px; }\r
\r
.profile-list-text { flex: 1; min-width: 0; }\r
\r
.profile-list-name {\r
  font-size: 13.5px;\r
  font-weight: 600;\r
...
\r
.profile-list-item .switch { pointer-events: none; }\r
\r
/* ==========================================================================\r
 * 12. Stepper row\r
 * ========================================================================== */\r
.stepper-row {\r
  ...
  align-items: center;\r
  justify-content: space-between;\r
  padding: 0.625rem 1rem;\r
  background: var(--__card);\r
  border-radius: 3px;\r
  margin: 0 1.25rem 0.375rem;\r
}\r
\r
.stepper-row-header {\r
  display: flex;\r
  align-items: center;\r
  gap: 0.375rem;\r
}\r
...
.stepper {\r
  ...
  background: var(--__bg);\r
  border-radius: 3px;\r
  border: 1px solid var(--__divide);\r
}\r
\r
.stepper-btn {\r
  width: 34px;\r
  ...
  align-items: center;\r
  justify-content: center;\r
  color: var(--blakfy-a11y-primary);\r
  font-size: 20px;\r
  font-weight: 300;\r
  border: none;\r
  background: transparent;\r
  ...
  border-radius: 3px;\r
  flex-shrink: 0;\r
  transition: background 120ms ease;\r
}\r
.stepper-btn:hover { background: var(--__card); }\r
.stepper-btn:disabled { color: var(--__muted); cursor: default; }\r
.stepper-btn:focus-visible { outline: 2px solid var(--blakfy-a11y-focus-ring); }\r
\r
.stepper-value {\r
  min-width: 62px;\r
  text-align: center;\r
...
.toggle-row {\r
  ...
  border-radius: 3px;\r
  padding: 0.75rem 1rem;\r
  margin: 0 1.25rem 0.25rem;\r
  transition: background 150ms ease;\r
}\r
.toggle-row:hover { background: var(--__card-hover); }\r
\r
.toggle-text { flex: 1; min-width: 0; }\r
\r
.toggle-title-row {\r
  display: flex;\r
  align-items: center;\r
...
.info-btn {\r
  ...
  flex-shrink: 0;\r
  opacity: 0.45;\r
  transition: opacity 150ms ease, background 150ms ease;\r
}\r
.info-btn:hover, .info-btn:focus-visible {\r
  opacity: 1;\r
  background: var(--blakfy-a11y-primary);\r
  color: #ffffff;\r
}\r
.info-btn:focus-visible { outline: 2px solid var(--blakfy-a11y-focus-ring); outline-offset: 2px; }\r
\r
.info-tooltip {\r
  display: none;\r
  position: absolute;\r
  inset-inline-start: 0;\r
  inset-block-start: calc(100% + 6px);\r
  background: var(--__card);\r
  border: 1px solid var(--__divide);\r
  border-radius: 3px;\r
  ...
  color: var(--__text);\r
  inline-size: 220px;\r
  box-shadow: 0 8px 24px rgba(0,0,0,0.14);\r
  z-index: 100;\r
  pointer-events: none;\r
}\r
.info-wrap:hover .info-tooltip,\r
.info-wrap:focus-within .info-tooltip { display: block; }\r
\r
.info-tooltip-note {\r
  display: block;\r
  margin-block-start: 0.25rem;\r
  font-size: 10.5px;\r
  color: #f59e0b;\r
  font-style: italic;\r
}\r
...
.opt-label-row {\r
  ...
  align-items: center;\r
  gap: 0.375rem;\r
  padding: 0.625rem 1.25rem 0.25rem;\r
}\r
.opt-label-row .opt-section-title { margin-block-end: 0; }\r
\r
/* ==========================================================================\r
 * 16. Opt buttons\r
 * ========================================================================== */\r
.opt-buttons {\r
  ...
  flex-wrap: wrap;\r
  gap: 0.375rem;\r
  padding: 0 1.25rem 0.5rem;\r
}\r
\r
.opt-btn {\r
  min-block-size: 34px;\r
  ...
  white-space: nowrap;\r
  flex: 1;\r
  min-inline-size: fit-content;\r
  background: var(--__card);\r
  transition: background 150ms, border-color 150ms, color 150ms;\r
  opacity: 0.75;\r
}\r
.opt-btn:hover { background: var(--__card-hover); opacity: 1; }\r
.opt-btn[aria-pressed="true"] {\r
  background: var(--blakfy-a11y-primary);\r
  color: #ffffff;\r
  border-color: var(--blakfy-a11y-primary);\r
  opacity: 1;\r
}\r
.opt-btn:focus-visible { outline: 2px solid var(--blakfy-a11y-focus-ring); outline-offset: 2px; }\r
\r
/* ==========================================================================\r
 * 17. Panel footer\r
 * ========================================================================== */\r
.panel-footer {\r
  padding: 1.25rem 1.5rem;\r
  border-block-start: 1px solid var(--__divide);\r
  margin-block-start: 0.5rem;\r
}\r
\r
/* ==========================================================================\r
 * 18. Reset butonu\r
...
.btn-reset {\r
  ...
  font-family: inherit;\r
  cursor: pointer;\r
  transition: background 150ms, border-color 150ms;\r
}\r
.btn-reset:hover {\r
  background: var(--__card);\r
  border-color: var(--blakfy-a11y-primary);\r
}\r
.btn-reset[data-confirm="true"] {\r
  background: #dc2626;\r
  border-color: #dc2626;\r
  color: #fff;\r
}\r
.btn-reset:focus-visible { outline: 2px solid var(--blakfy-a11y-focus-ring); outline-offset: 2px; }\r
\r
/* ==========================================================================\r
 * 19. Disclaimer + branding\r
 * ========================================================================== */\r
.disclaimer {\r
  margin-top: 0.875rem;\r
  font-size: 11px;\r
  font-weight: 400;\r
  font-style: italic;\r
  line-height: 1.5;\r
  color: var(--__muted-dim);\r
}\r
\r
.panel-branding {\r
  display: flex;\r
...
.panel-branding:hover { background: rgba(59,130,246,0.07); }\r
.panel-branding:focus-visible { outline: 2px solid var(--blakfy-a11y-focus-ring); outline-offset: 2px; border-radius: 3px; }\r
\r
.panel-branding-powered {\r
  font-size: 11px;\r
  font-weight: 400;\r
  color: var(--__muted);\r
}\r
.panel-branding-name {\r
  font-size: 12px;\r
  font-weight: 700;\r
  color: var(--blakfy-a11y-primary);\r
}\r
 ...
 * 20. Animations\r
 * ========================================================================== */\r
@keyframes blakfy-fade-in  { from { opacity: 0; } to { opacity: 1; } }\r
@keyframes blakfy-fade-out { from { opacity: 1; } to { opacity: 0; } }\r
\r
@keyframes blakfy-slide-in-right {\r
  from { transform: translateX(100%); opacity: 0; }\r
  to   { transform: translateX(0);    opacity: 1; }\r
}\r
@keyframes blakfy-slide-out-right {\r
...
@media (prefers-reduced-motion: reduce) {\r
  *, *::before, *::after {\r
    animation-duration: 0.001ms !important;\r
    animation-iteration-count: 1 !important;\r
    transition-duration: 0.001ms !important;\r
  }\r
}\r
\r
/* ==========================================================================\r
...
@media (max-width: 480px) {\r
  .fab { --blakfy-a11y-fab-size: 44px; }\r
  .dialog { inline-size: 100vw; }\r
}\r
\r
/* ==========================================================================\r
 * 23. Forced colors / Windows High Contrast\r
 * ========================================================================== */\r
@media (forced-colors: active) {\r
  .fab, .btn-reset, .opt-btn, .switch {\r
    border: 1px solid CanvasText;\r
    forced-color-adjust: none;\r
  }\r
  .switch[aria-checked="true"] { background: Highlight; }\r
  .switch-thumb { background: HighlightText; }\r
}\r
`,Kt="2.0.0-alpha.0";function Vt(e){const n={open:()=>O(E.OPEN,{}),close:()=>O(E.CLOSE,{}),getPreferences:()=>oe(),setPreferences:t=>{xe(t,e.config.locale)},reset:()=>{cn(e.config.locale)},onChange:t=>K(E.CHANGE,i=>t(i.prefs)),configure:t=>e.configure(t),diagnostics:()=>ft({config:e.config,performance:{mountTimeMs:e.mountTimeMs,bundleSizeGz:e.bundleSizeGz,timeToFirstClick:null},storage:e.storage}),version:Kt};return typeof window<"u"&&(window.BlakfyA11y&&typeof window.BlakfyA11y=="object"?Object.assign(window.BlakfyA11y,n):window.BlakfyA11y=n),n}const $n="blakfy-a11y-root",Le="2.0.0-alpha.0";function Yt(e){const n=e.toLowerCase().split(/[-_]/)[0]??"";return{tr:"tr",en:"en",de:"de",fr:"fr",es:"es",it:"it",ar:"ar",he:"he",ru:"ru",iw:"he"}[n]}function Xt(){if(typeof document>"u")return"en";const e=document.documentElement.lang??"";return Yt(e)??"en"}function Jt(){if(typeof document>"u")return{};let e=Tn??document.currentScript;if(!e){const i=document.querySelectorAll("script[src]");for(let a=0;a<i.length;a++){const r=i[a];if(r&&r.src&&/accessibility[-_]widget|blakfy|widget\.js$/i.test(r.src)){e=r;break}}}if(!e)return{};const n=e.dataset,t={};return n.locale?t.locale=n.locale:t.locale=Xt(),n.theme&&(t.theme=n.theme),n.position&&(t.position=n.position),n.font&&(t.font=n.font),n.debug&&(t.debug=n.debug==="true"),n.devPipe&&(t.devPipe=n.devPipe),n.version&&(t.version=n.version),t}function Zt(){if(typeof document>"u")return!0;const e=document.querySelectorAll("link[href]");for(let n=0;n<e.length;n++){const t=e[n];if(t&&t.href&&/open[-_]?dyslexic/i.test(t.href))return!0}return!1}function Qt(e){if(typeof document>"u")return{mismatched:!1,fields:[]};const n=document.documentElement;if(!n)return{mismatched:!1,fields:[]};const t={"data-a11y-fontscale":String(e.fontScale),"data-a11y-contrast":e.contrast,"data-a11y-focus":e.focusRing?"enhanced":"default","data-a11y-links":e.linkUnderline?"underline":"default","data-a11y-motion":e.motion,"data-a11y-dyslexia":String(e.dyslexiaFont),"data-a11y-reading":String(e.readingMode)},i=[];let a=!1;for(const r of Object.keys(t)){if(!n.hasAttribute(r))continue;a=!0,n.getAttribute(r)!==t[r]&&i.push(r)}return{mismatched:a&&i.length>0,fields:i}}function Ln(e){try{const n=new URL(e);return n.origin+n.pathname.replace(/\/[^/]*$/,"")}catch{return""}}const Tn=typeof document<"u"?document.currentScript:null,Rn=typeof document<"u"?Ln(Tn?.src??""):"";function Mn(){if(typeof document>"u")return"";if(Rn)return Rn;const e=document.querySelectorAll("script[src]");for(let n=0;n<e.length;n++){const t=e[n];if(t&&t.src&&/accessibility[-_]widget|blakfy|widget\.js$/i.test(t.src)){const i=Ln(t.src);if(i)return i}}return""}function er(e){return Gn.includes(e)}function nr(e){if(e==="dark")return"dark";if(e==="light")return"light";if(typeof document<"u"){const n=document.documentElement,t=n.getAttribute("data-theme");if(t==="dark")return"dark";if(t==="light")return"light";if(n.getAttribute("data-color-mode")==="dark"||n.classList.contains("dark"))return"dark";if(n.classList.contains("light"))return"light"}if(typeof window>"u"||typeof window.matchMedia!="function")return"light";try{return window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}catch{return"light"}}function tr(e){if(typeof MutationObserver>"u"||typeof document>"u")return()=>{};const n=new MutationObserver(e);return n.observe(document.documentElement,{attributes:!0,attributeFilter:["class","data-theme","data-color-mode"]}),()=>n.disconnect()}function V(e,n){e.setAttribute("data-position",n.position),e.setAttribute("data-theme",nr(n.theme)),e.setAttribute("dir",er(n.locale)?"rtl":"ltr"),n.font&&e.style.setProperty("font-family",n.font)}function rr(e){const n=document.createElement("style");n.textContent=Wt,e.appendChild(n)}function ir(){const e=document.querySelector($n);if(e&&e instanceof HTMLElement)return e;const n=document.createElement($n);return document.body.appendChild(n),n}function Te(e={}){const n=typeof performance<"u"?performance.now():Date.now();if(typeof document>"u")return{unmount:()=>{}};const t=Jt(),i=typeof window<"u"?window.__BLAKFY_A11Y__??{}:{};let r=Ze({...t,...i,...e});const o=oe(),c=Qt(o);c.mismatched&&A("error","SSR_HYDRATION_MISMATCH",`SSR-rendered prefs differ from client storage: ${c.fields.join(", ")}`),ie(o),t.version&&t.version!==Le&&A("error","CDN_VERSION_MISMATCH",`Expected version ${t.version} but runtime is ${Le} — clear your CDN cache.`),o.dyslexiaFont&&!Zt()&&A("warn","OPENDYSLEXIC_CDN_MISSING","dyslexiaFont=true but no OpenDyslexic CDN <link> found — system fallback active."),at()&&A("warn","HOST_CSS_IMPORTANT_CONFLICT","Host stylesheet uses !important on body/a — visual prefs may not apply.");const p=ke();p.reducedMotion&&A("info","OS_PREFERS_REDUCED_MOTION","OS prefers-reduced-motion=reduce detected."),p.contrast==="more"&&A("info","OS_PREFERS_CONTRAST_MORE","OS prefers-contrast=more detected."),p.colorScheme==="dark"&&A("info","OS_PREFERS_COLOR_SCHEME_DARK","OS prefers-color-scheme=dark detected.");const u=lt(()=>{m.config.theme==="auto"&&(V(m.host,m.config),m.rerender())}),_=tr(()=>{m.config.theme==="auto"&&(V(m.host,m.config),m.rerender())});t.devPipe&&ut(t.devPipe);let s=null;if(typeof i.onPreferencesChange=="function"){const b=i.onPreferencesChange;s=K(E.CHANGE,k=>{try{b(k)}catch{}})}const h=ir(),f=h.shadowRoot??h.attachShadow({mode:"open"});for(;f.firstChild;)f.removeChild(f.firstChild);rr(f),V(h,r);let v=un();const m={config:r,translation:v,shadowRoot:f,host:h,rerender:()=>{Ve(Fe(qt,{config:m.config,translation:m.translation,onThemeChange:b=>{m.config={...m.config,theme:b},V(h,m.config),m.rerender()}}),f)}};if(m.rerender(),r.locale!=="en"){const b=Mn();dn(r.locale,b).then(k=>{v=k,m.translation=k,m.rerender()})}const w=vt(),y=(typeof performance<"u"?performance.now():Date.now())-n;return Vt({config:r,mountTimeMs:y,bundleSizeGz:0,storage:w,configure:b=>{const k=Ze({...m.config,...b}),L=k.locale!==m.config.locale;if(m.config=k,V(h,k),L)if(k.locale==="en")m.translation=un(),m.rerender();else{const ue=Mn();dn(k.locale,ue).then(G=>{m.translation=G,m.rerender()})}else m.rerender()}}),A("info","INITIALIZED",`Widget mounted in ${y.toFixed(1)}ms`),O(E.READY,{version:Le}),{unmount:()=>{u(),_(),s&&s(),Ve(null,f),h.parentNode&&h.parentNode.removeChild(h)}}}const Hn="blakfy-a11y";class In extends HTMLElement{constructor(){super(...arguments);Me(this,"_unmount",null)}connectedCallback(){if(this._unmount)return;const t=this._readAttributes(),i=Te(t);this._unmount=i.unmount}disconnectedCallback(){this._unmount&&(this._unmount(),this._unmount=null)}attributeChangedCallback(t,i,a){if(i===a||!this._unmount||typeof window>"u"||!window.BlakfyA11y)return;const r=this._readAttributes();window.BlakfyA11y.configure(r)}_readAttributes(){const t={},i=this.getAttribute("locale");i&&(t.locale=i);const a=this.getAttribute("theme");a&&(t.theme=a);const r=this.getAttribute("position");r&&(t.position=r);const o=this.getAttribute("font");o&&(t.font=o);const c=this.getAttribute("debug");return c!=null&&(t.debug=c==="true"),t}}Me(In,"observedAttributes",["locale","theme","position","font","debug"]);function On(){typeof customElements>"u"||customElements.get(Hn)||customElements.define(Hn,In)}const or="blakfy-a11y-root",ar="blakfy-a11y";function Pn(){typeof document>"u"||document.querySelector(or)||document.querySelector(ar)||Te()}On(),typeof document<"u"&&(document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Pn,{once:!0}):Pn()),M.defineCustomElement=On,M.mount=Te,Object.defineProperty(M,Symbol.toStringTag,{value:"Module"})})(this.BlakfyA11y=this.BlakfyA11y||{});
